...
export interface GrammarDay {
  ...
  title: string
  titleEn: string
  category: 'Tenses' | 'S-V Agreement' | 'Passive' | 'Conditionals' | 'Clauses' | 'Parts of Speech' | 'Collocations' | 'Conjunctions' | 'Prepositions' | 'Review & Test'
...
export const GRAMMAR_30_DAYS: GrammarDay[] = [
  {
    ...
    "pageBookRef": 14,
    "summary": "Nắm vững cấu trúc, cách sử dụng và dấu hiệu nhận biết của 3 thì đơn: Hiện tại đơn (Present Simple), Quá khứ đơn (Past Simple) và Tương lai đơn (Future Simple).",
    "coreFormulas": [
      {
        "formula": "S + V(s/es) / S + do/does not + V_inf",
        "meaning": "Hiện tại đơn: Diễn tả chân lý, sự thật hiển nhiên, thói quen lặp đi lặp lại hoặc lịch trình biểu.",
      ...
      },
      {
        ...
        "meaning": "Quá khứ đơn: Diễn tả hành động đã xảy ra và kết thúc hoàn toàn tại thời điểm xác định trong quá khứ.",
      ...
      },
      {
        ...
        "meaning": "Tương lai đơn: Quyết định tức thì tại thời điểm nói, lời hứa, dự đoán không có căn cứ xác thực.",
    ...
    "exercises": [
      {
        "id": "d1-q1",
        "question": "Mr. Henderson usually _______ the quarterly financial audit before sending it to the board.",
        "options": [
          "reviews",
          "is reviewing",
          "reviewed",
        ...
        "translation": "Ông Henderson thường xem xét kỹ lưỡng cuộc kiểm toán tài chính hàng quý trước khi gửi cho hội đồng quản trị.",
        "detailedExplanation": "Dấu hiệu trạng từ 'usually' biểu thị thói quen lặp đi lặp lại ➔ dùng Hiện tại đơn. Chủ ngữ 'Mr. Henderson' là ngôi thứ 3 số ít ➔ động từ thêm -s ('reviews').",
        "examTrap": "Không chia thì tiếp diễn với trạng từ tần suất chỉ thói quen công việc đều đặn."
      },
      {
        "id": "d1-q2",
        "question": "The human resources department _______ an official announcement regarding the annual bonus yesterday morning.",
        "options": [
          "issues",
          "issued",
          "is issuing",
        ...
        "type": "multiple-choice",
        "difficulty": "A1-A2 Foundation",
        "translation": "Phòng nhân sự đã phát đi thông báo chính thức về tiền thưởng hàng năm vào sáng hôm qua.",
        "detailedExplanation": "Có trạng ngữ thời gian xác định trong quá khứ 'yesterday morning' ➔ chia thì Quá khứ đơn (V-ed: 'issued').",
        "examTrap": "Tránh nhầm lẫn giữa Hiện tại hoàn thành và Quá khứ đơn khi có mốc thời gian kết thúc xác định."
      },
      {
        "id": "d1-q3",
        "question": "As soon as the technician _______ the server maintenance, we will resume client operations.",
        "options": [
          "will finish",
          "finishes",
          "finished",
        ...
        "translation": "Ngay sau khi kỹ thuật viên hoàn tất việc bảo trì máy chủ, chúng tôi sẽ tiếp tục các hoạt động phục vụ khách hàng.",
        "detailedExplanation": "Quy tắc kinh điển trong TOEIC: Trong mệnh đề phụ chỉ thời gian bắt đầu bằng 'As soon as', mệnh đề chính dùng 'will resume' (tương lai) thì mệnh đề phụ BẮT BUỘC dùng Hiện tại đơn ('finishes'), KHÔNG BAO GIỜ dùng 'will'.",
        "examTrap": "Đây là bẫy câu hỏi Part 5 TOEIC thường xuyên xuất hiện với tần suất trên 80% trong các đề thi."
      }
    ]
  },
  {
    ...
    "pageBookRef": 20,
    "summary": "Chuyên sâu các bẫy đề thi Part 5 TOEIC về thì đơn: Hòa hợp thì trong mệnh đề thời gian, động từ trạng thái không chia tiếp diễn, và sự khác biệt giữa lịch trình cố định và tương lai gần.",
    "coreFormulas": [
      {
        "formula": "Clause (Future Simple: will + V) + when/before/after/as soon as/until + S + V(s/es) (Present Simple)",
      ...
      {
        "formula": "Stative Verbs (know, believe, understand, contain, belong to, own, resemble) ➔ KHÔNG chia V-ing",
        "meaning": "Động từ chỉ trạng thái, sở hữu, cảm xúc luôn chia ở dạng thì đơn, không dùng thì tiếp diễn.",
    ...
    "exercises": [
      {
        "id": "d2-q1",
        "question": "Payment will be released to the contractor once the project supervisor _______ the completed construction inspection.",
        "options": [
          "approves",
          "will approve",
          "approved",
        ...
        "type": "multiple-choice",
        "difficulty": "B1-B2 Intermediate",
        "translation": "Khoản thanh toán sẽ được giải ngân cho nhà thầu một khi người giám sát dự án phê duyệt đợt nghiệm thu thi công hoàn tất.",
        "detailedExplanation": "Liên từ 'once' (= as soon as / sau khi). Mệnh đề chính có 'will be released' (tương lai) ➔ mệnh đề sau 'once' phải chia Hiện tại đơn số ít: 'approves'.",
        "examTrap": "Thí sinh rất hay chọn 'will approve' vì thấy vế trước có will."
      },
      {
        "id": "d2-q2",
        "question": "The latest version of our cloud software _______ advanced end-to-end encryption protocols.",
        "options": [
          "is containing",
          "contains",
          "was contained",
        ...
        "type": "multiple-choice",
        "difficulty": "B1-B2 Intermediate",
        "translation": "Phiên bản mới nhất của phần mềm đám mây của chúng tôi chứa các giao thức mã hóa đầu cuối tiên tiến.",
        "detailedExplanation": "'Contain' là động từ trạng thái (stative verb), không chia ở thể tiếp diễn ('is containing' là sai). Chủ ngữ 'The latest version' là số ít ➔ chọn 'contains'.",
        "examTrap": "Bẫy động từ trạng thái chỉ bản chất tính năng sản phẩm."
      },
      {
        "id": "d2-q3",
        "question": "The high-speed express train to Frankfurt _______ from platform 4 at exactly 6:45 PM this evening.",
        "options": [
          "departs",
          "is departing",
          "will be departed",
        ...
        "translation": "Chuyến tàu cao tốc đi Frankfurt khởi hành từ sân ga số 4 vào đúng 6 giờ 45 tối nay.",
        "detailedExplanation": "Hành động trong tương lai nhưng tuân theo lịch trình cố định của phương tiện giao thông công cộng, thời khóa biểu công khai ➔ quy chuẩn ngữ pháp tiếng Anh chuẩn mực dùng thì Hiện tại đơn ('departs').",
        "examTrap": "Đề thi TOEIC điểm cao 850+ rất chuộng kiểm tra cách dùng Hiện tại đơn chỉ lịch trình cố định."
      }
    ]
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 30,
    "summary": "Nắm chắc 3 thì tiếp diễn: Hiện tại tiếp diễn, Quá khứ tiếp diễn và Tương lai tiếp diễn. Nhận diện các hành động đang xảy ra, hành động xen vào và hành động song song.",
    "coreFormulas": [
      {
        "formula": "S + am/is/are + V-ing",
        "meaning": "Hiện tại tiếp diễn: Diễn tả hành động đang diễn ra ngay tại thời điểm nói hoặc xu hướng biến đổi tạm thời.",
      ...
      },
      {
        ...
        "meaning": "Quá khứ tiếp diễn: Hành động đang xảy ra tại một thời điểm xác định trong quá khứ hoặc một hành động đang xảy ra thì hành động khác cắt ngang (When + Past Simple, While + Past Continuous).",
      ...
      },
      {
        ...
        "meaning": "Tương lai tiếp diễn: Diễn tả hành động sẽ đang diễn ra tại một thời điểm hoặc khoảng thời gian xác định trong tương lai.",
        "exampleEn": "Our CEO will be delivering the keynote speech at this time tomorrow.",
        "exampleVi": "Tổng giám đốc của chúng tôi sẽ đang trình bày bài phát biểu khai mạc vào giờ này ngày mai.",
        "signals": [
    ...
    "exercises": [
      {
        "id": "d3-q1",
        "question": "While the system administrators _______ the firewall upgrade, external connections were temporarily disabled.",
        "options": [
          "were installing",
          "installed",
          "are installing",
        ...
        "type": "multiple-choice",
        "difficulty": "B1-B2 Intermediate",
        "translation": "Trong khi các quản trị viên hệ thống đang cài đặt bản nâng cấp tường lửa, các kết nối bên ngoài tạm thời bị vô hiệu hóa.",
        "detailedExplanation": "Mệnh đề sau 'While' diễn tả hành động đang diễn ra trong quá khứ kéo dài ('were installing'), vế sau là hành động đồng thời/kết quả trong quá khứ ('were disabled').",
        "examTrap": "Chủ ngữ 'administrators' số nhiều nên phải dùng 'were installing', không dùng 'was'."
      },
      {
        "id": "d3-q2",
        "question": "At this exact hour next Friday, the executive committee _______ candidate presentations for the vacant director role.",
        "options": [
          "will be reviewing",
          "reviewed",
          "has reviewed",
        ...
        "type": "multiple-choice",
        "difficulty": "B1-B2 Intermediate",
        "translation": "Vào đúng giờ này thứ Sáu tuần tới, ủy ban điều hành sẽ đang xem xét các bài thuyết trình của ứng viên cho vị trí giám đốc còn trống.",
        "detailedExplanation": "Có mốc thời gian cụ thể trong tương lai 'At this exact hour next Friday' ➔ chia thì Tương lai tiếp diễn ('will be reviewing').",
        "examTrap": "Nhiều người chỉ chú ý 'next Friday' mà bỏ qua 'at this exact hour' nên chọn nhầm thì tương lai đơn."
      }
    ]
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 44,
    "summary": "Làm chủ các thì hoàn thành: Hiện tại hoàn thành (kết quả ở hiện tại), Quá khứ hoàn thành (xảy ra trước một hành động quá khứ), và Tương lai hoàn thành (hoàn tất trước mốc tương lai).",
    "coreFormulas": [
      {
        "formula": "S + have/has + V3/ed",
        "meaning": "Hiện tại hoàn thành: Diễn tả hành động xảy ra trong quá khứ kéo dài đến hiện tại, hoặc vừa mới xảy ra để lại kết quả.",
        "exampleEn": "TechCorp has experienced unprecedented revenue growth over the past three years.",
        "exampleVi": "Tập đoàn TechCorp đã trải qua sự tăng trưởng doanh thu chưa từng có trong vòng 3 năm qua.",
        "signals": [
          "since",
      ...
      {
        "formula": "S + had + V3/ed",
        "meaning": "Quá khứ hoàn thành: Hành động xảy ra và hoàn tất TRƯỚC một hành động hoặc mốc thời gian khác trong quá khứ.",
        "exampleEn": "By the time the manager arrived, the team had already finalized the technical report.",
      ...
      },
      {
        ...
        "meaning": "Tương lai hoàn thành: Hành động sẽ được hoàn tất TRƯỚC một thời điểm hoặc hành động khác trong tương lai.",
        "exampleEn": "By next December, we will have operated this data center for a decade.",
        "exampleVi": "Tính đến tháng 12 tới, chúng tôi sẽ vận hành trung tâm dữ liệu này tròn một thập kỷ.",
        "signals": [
    ...
    "exercises": [
      {
        "id": "d4-q1",
        "question": "Over the last two decades, our software firm _______ its global customer base across forty countries.",
        "options": [
          "has expanded",
          "expands",
          "expanded",
        ...
        "type": "multiple-choice",
        "difficulty": "B1-B2 Intermediate",
        "translation": "Trong hai thập kỷ qua, công ty phần mềm của chúng tôi đã mở rộng tệp khách hàng toàn cầu trên bốn mươi quốc gia.",
        "detailedExplanation": "Cụm 'Over the last two decades' là dấu hiệu đặc trưng tuyệt đối của thì Hiện tại hoàn thành ➔ chia 'has expanded'.",
        "examTrap": "Không chia quá khứ đơn khi có cụm 'Over / In / During the past / last + khoảng thời gian'."
      },
      {
        "id": "d4-q2",
        "question": "By the time the new director assumed leadership, the previous administration _______ the restructuring plan.",
        "options": [
          "had implemented",
          "implements",
          "will implement",
        ...
        "type": "multiple-choice",
        "difficulty": "C1 / TOEIC 800+",
        "translation": "Trước khi vị giám đốc mới tiếp quản quyền lãnh đạo, ban điều hành tiền nhiệm đã triển khai xong kế hoạch tái cơ cấu.",
        "detailedExplanation": "'By the time' + mệnh đề quá khứ đơn ('assumed') ➔ mệnh đề chính biểu thị hành động xảy ra trước đó, phải dùng Quá khứ hoàn thành ('had implemented').",
        "examTrap": "Bẫy tương quan thời gian giữa hành động xảy ra trước và hành động xảy ra sau trong quá khứ."
      }
    ]
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 53,
    "summary": "Quy tắc hòa hợp số ít và số nhiều, chủ ngữ ghép với AND, và các đại từ bất định (Everyone, Each, Every).",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 5: SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ I",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ I.",
        "exampleEn": "Professional English example demonstrating Subject-Verb Agreement: Core Rules.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ I.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
    ...
    "exercises": [
      {
        "id": "d5-q1",
        "question": "The regional director emphasized that all department staff must comply _______ updated safety regulations.",
        "options": [
          "with",
          "to",
          "for",
        ...
        "type": "multiple-choice",
        "difficulty": "A1-A2 Foundation",
        "translation": "Giám đốc khu vực nhấn mạnh rằng toàn thể nhân viên phòng ban phải tuân thủ các quy định an toàn đã cập nhật.",
        "detailedExplanation": "Cụm giới từ cố định (Collocation / Dependent preposition): 'comply with something' mang nghĩa tuân thủ, tuân theo quy định.",
        "examTrap": "Thí sinh rất hay nhầm lẫn giữa 'comply with', 'conform to' và 'adhere to'."
      },
      {
        "id": "d5-q2",
        "question": "Despite _______ multiple budget reductions, the engineering team successfully delivered the mobile app on schedule.",
        "options": [
          "facing",
          "faced",
          "faces",
        ...
        "type": "multiple-choice",
        "difficulty": "A1-A2 Foundation",
        "translation": "Mặc dù phải đối mặt với nhiều lần cắt giảm ngân sách, đội ngũ kỹ thuật đã bàn giao thành công ứng dụng di động đúng tiến độ.",
        "detailedExplanation": "Sau giới từ 'Despite', ta phải dùng danh từ, cụm danh từ hoặc Danh động từ V-ing ('facing').",
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 58,
    "summary": "Quy tắc với As well as, Together with, A number of vs The number of, phân số và tỷ lệ phần trăm.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 6: SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ II",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ II.",
        "exampleEn": "Professional English example demonstrating Subject-Verb Agreement: Advanced & Traps.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của SỰ HÒA HỢP GIỮA CHỦ NGỮ VÀ ĐỘNG TỪ II.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 66,
    "summary": "Tổng hợp và luyện đề thực chiến toàn bộ kiến thức 12 thì tiếng Anh và quy tắc hòa hợp chủ vị.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 7: REVIEW TUẦN 1 (TỔNG ÔN THÌ & HÒA HỢP S-V)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của REVIEW TUẦN 1 (TỔNG ÔN THÌ & HÒA HỢP S-V).",
        "exampleEn": "Professional English example demonstrating Week 1 Comprehensive Review & Practice Test.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của REVIEW TUẦN 1 (TỔNG ÔN THÌ & HÒA HỢP S-V).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 70,
    "summary": "Cấu trúc bị động, động từ 2 tân ngữ, bị động đặc biệt và bẫy nội động từ không có bị động.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 8: BẪY VỀ CÂU BỊ ĐỘNG TRONG ĐỀ THI TOEIC",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của BẪY VỀ CÂU BỊ ĐỘNG TRONG ĐỀ THI TOEIC.",
        "exampleEn": "Professional English example demonstrating Passive Voice Mastery & Exam Traps.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của BẪY VỀ CÂU BỊ ĐỘNG TRONG ĐỀ THI TOEIC.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 76,
    "summary": "Câu điều kiện loại 1 (có thật ở hiện tại/tương lai), loại 2 (giả định trái ngược hiện tại), loại 3 (trái ngược quá khứ).",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 9: CẤU TRÚC BA LOẠI CÂU ĐIỀU KIỆN CƠ BẢN",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của CẤU TRÚC BA LOẠI CÂU ĐIỀU KIỆN CƠ BẢN.",
        "exampleEn": "Professional English example demonstrating Conditionals Type 1, 2, 3 Essentials.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CẤU TRÚC BA LOẠI CÂU ĐIỀU KIỆN CƠ BẢN.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "C1 / TOEIC 800+",
    "pageBookRef": 86,
    "summary": "Điều kiện hỗn hợp (Mixed conditionals) và đảo ngữ với Should, Were, Had trong đề thi TOEIC.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Mixed Conditionals & Inversion in Conditionals.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÂU ĐIỀU KIỆN NÂNG CAO VÀ ĐẢO NGỮ.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
    ...
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Relative Pronouns & Defining Clauses.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của MỆNH ĐỀ QUAN HỆ (RELATIVE CLAUSES).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 97,
    "summary": "Rút gọn mệnh đề quan hệ dạng V-ing (chủ động), V-ed/V3 (bị động) và To-V; giới từ đi kèm đại từ quan hệ.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Reduced Relative Clauses & Advanced Traps.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của BẪY MỆNH ĐỀ QUAN HỆ & RÚT GỌN.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
    ...
    "coreFormulas": [
      {
        ...
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của REVIEW TUẦN 2 (BỊ ĐỘNG, ĐIỀU KIỆN, MỆNH ĐỀ).",
        "exampleEn": "Professional English example demonstrating Week 2 Comprehensive Review & Test.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của REVIEW TUẦN 2 (BỊ ĐỘNG, ĐIỀU KIỆN, MỆNH ĐỀ).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 106,
    "summary": "Phân biệt đại từ nhân xưng, tân ngữ, tính từ sở hữu, đại từ sở hữu và đại từ phản thân (-self/-selves).",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 14: ĐẠI TỪ (PRONOUNS)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của ĐẠI TỪ (PRONOUNS).",
        "exampleEn": "Professional English example demonstrating Personal, Possessive & Reflexive Pronouns.",
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 114,
    "summary": "Vị trí của danh từ trong câu, dấu hiệu nhận biết đuôi danh từ (-tion, -ment, -ness, -ity, -ance, -er, -or).",
    "coreFormulas": [
      {
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 120,
    "summary": "Danh từ không đếm được đặc trưng trong TOEIC (information, equipment, advice, luggage) và lượng từ (many/much, few/little).",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Countable vs Uncountable Nouns & Quantifiers.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của DANH TỪ ĐẾM ĐƯỢC VÀ KHÔNG ĐẾM ĐƯỢC.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 127,
    "summary": "Các cụm collocation danh từ kinh điển: take responsibility, make a decision, gain access to, express interest in.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Essential Business Noun Collocations.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÁC COLLOCATION DANH TỪ THƯỜNG GẶP.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "C1 / TOEIC 800+",
    "pageBookRef": 131,
    "summary": "Bẫy phân biệt danh từ chỉ người và chỉ vật (applicant vs application) và cụm danh từ ghép (compound nouns).",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Noun Traps: Person vs Thing & Compounds.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của BẪY DANH TỪ TRONG MỆNH ĐỀ TOEIC.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 137,
    "summary": "Vị trí tính từ trước danh từ và sau linking verbs; phân biệt tính từ đuôi -ing (bản chất) và -ed (cảm xúc).",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 19: TÍNH TỪ (ADJECTIVES)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của TÍNH TỪ (ADJECTIVES).",
        "exampleEn": "Professional English example demonstrating Adjective Functions, Suffixes & -ing vs -ed.",
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 145,
    "summary": "Các cụm tính từ chuyên nghiệp: highly competitive, strongly recommended, deeply concerned, mutually beneficial.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 20: CÁC COLLOCATION CỦA TÍNH TỪ THƯỜNG GẶP",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của CÁC COLLOCATION CỦA TÍNH TỪ THƯỜNG GẶP.",
        "exampleEn": "Professional English example demonstrating High-Frequency Adjective Collocations.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÁC COLLOCATION CỦA TÍNH TỪ THƯỜNG GẶP.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "C1 / TOEIC 800+",
    "pageBookRef": 153,
    "summary": "Bẫy tính từ có đuôi -ly (friendly, timely, costly), trật tự tính từ trước danh từ và tính từ ghép.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Adjective Traps: -ly Adjectives & OSASCOMP.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của BẪY TÍNH TỪ TRONG ĐỀ THI TOEIC.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 161,
    "summary": "Vị trí và chức năng của trạng từ: bổ nghĩa cho động từ thường, tính từ, trạng từ khác và cả mệnh đề.",
    "coreFormulas": [
      {
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 165,
    "summary": "Các cặp trạng từ - động từ chuẩn mực: promptly respond, strictly prohibited, substantially increase, closely monitor.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Professional Adverb-Verb & Adverb-Adj Pairs.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÁC COLLOCATION CỦA TRẠNG TỪ.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 174,
    "summary": "Tổng ôn tập và kiểm tra toàn diện danh từ, tính từ, trạng từ, đại từ và hệ thống collocations.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 24: REVIEW TUẦN 3 (TỔNG ÔN TỪ LOẠI & COLLOCATIONS)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của REVIEW TUẦN 3 (TỔNG ÔN TỪ LOẠI & COLLOCATIONS).",
        "exampleEn": "Professional English example demonstrating Week 3 Comprehensive Review & Test.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của REVIEW TUẦN 3 (TỔNG ÔN TỪ LOẠI & COLLOCATIONS).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 178,
    "summary": "Các cụm động từ công sở phổ biến: conduct a survey, meet expectations/deadlines, implement policies, address concerns.",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Must-Know Business Verb Collocations.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÁC COLLOCATION CỦA ĐỘNG TỪ.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 188,
    "summary": "Cụm động từ không thể bỏ qua: comply with, rely on, deal with, look forward to, call off, put off, bring about.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 26: CÁC CỤM ĐỘNG TỪ VÀ GIỚI TỪ (PHRASAL VERBS)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của CÁC CỤM ĐỘNG TỪ VÀ GIỚI TỪ (PHRASAL VERBS).",
        "exampleEn": "Professional English example demonstrating Phrasal Verbs & Dependent Prepositions.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của CÁC CỤM ĐỘNG TỪ VÀ GIỚI TỪ (PHRASAL VERBS).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 192,
    "summary": "Liên từ kết hợp (FANBOYS: For, And, Nor, But, Or, Yet, So) và liên từ tương quan (either...or, neither...nor, both...and, not only...but also).",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 27: LIÊN TỪ (1) - COORDINATING & CORRELATIVE",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của LIÊN TỪ (1) - COORDINATING & CORRELATIVE.",
        "exampleEn": "Professional English example demonstrating Coordinating & Correlative Conjunctions.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của LIÊN TỪ (1) - COORDINATING & CORRELATIVE.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "B1-B2 Intermediate",
    "pageBookRef": 197,
    "summary": "Phân biệt liên từ (nối mệnh đề) và giới từ (đi với danh từ/cụm danh từ): Although vs Despite, Because vs Because of, While vs During.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 28: LIÊN TỪ (2) - SUBORDINATING CONJUNCTIONS",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của LIÊN TỪ (2) - SUBORDINATING CONJUNCTIONS.",
        "exampleEn": "Professional English example demonstrating Subordinating Conjunctions vs Prepositions.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của LIÊN TỪ (2) - SUBORDINATING CONJUNCTIONS.",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
  ...
  },
  {
    ...
    "level": "A1-A2 Foundation",
    "pageBookRef": 204,
    "summary": "Quy tắc dùng giới từ thời gian (in, on, at, by, until, within, during) và nơi chốn (in, on, at, between, among).",
    "coreFormulas": [
      {
        ...
        "exampleEn": "Professional English example demonstrating Prepositions of Time, Place & Direction.",
  ...
  },
  {
    ...
    "level": "C1 / TOEIC 800+",
    "pageBookRef": 210,
    "summary": "Đề thi tổng hợp toàn diện 30 ngày ngữ pháp chuẩn format đề thi TOEIC Part 5 & 6 với lời giải chi tiết từng câu.",
    "coreFormulas": [
      {
        "formula": "Key Formula for Day 30: TEST TỔNG ÔN 30 NGÀY (FINAL COMPREHENSIVE EXAM)",
        "meaning": "Công thức trọng tâm và nguyên lý cốt lõi của TEST TỔNG ÔN 30 NGÀY (FINAL COMPREHENSIVE EXAM).",
        "exampleEn": "Professional English example demonstrating Final 30-Day TOEIC & Grammar Examination.",
        "exampleVi": "Ví dụ tiếng Anh chuyên nghiệp minh họa cấu trúc của TEST TỔNG ÔN 30 NGÀY (FINAL COMPREHENSIVE EXAM).",
        "signals": [
          "crucial indicator",
          "context cue",
          "exam keyword"
