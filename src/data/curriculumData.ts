...
export const EXPANDED_CURRICULUM_METADATA: RawVideoMeta[] = [
  {
    videoId: '18c3MTX0PK0',
    title: 'Welcome to C++: Systems Programming Core',
    channel: 'The Cherno',
    durationFormatted: '06:12',
    description:
      'Học lập trình hệ thống C++ hiện đại: Biên dịch mã nguồn, Stack vs Heap và con trỏ.',
    tags: ['C++', 'Systems', 'The Cherno'],
    levelRank: 'Intern',
  },
  {
    videoId: '8jLOx1hD3_o',
    ...
    description: 'Giáo trình C++ thực chiến: Biến, con trỏ, tham chiếu, bộ nhớ động.',
    tags: ['C++', 'Pointers', 'freeCodeCamp'],
    levelRank: 'Intern',
  },
  {
    videoId: 'B31LgI4Y4DQ',
    ...
    description: 'Cấu trúc dữ liệu cốt lõi: Linked List, Stack, Queue, Tree & Graph.',
    tags: ['Data Structures', 'C++', 'Algorithms'],
    levelRank: 'Intern',
  },
  {
    videoId: 'KLlXCFG5TnA',
    title: 'Two Sum - LeetCode 1 & Big-O Complexity Analysis',
    channel: 'NeetCode',
    durationFormatted: '11:27',
    description: 'Phân tích thuật toán Two Sum và HashMap tối ưu O(n) chuẩn phỏng vấn FAANG.',
    tags: ['LeetCode', 'NeetCode', 'Big-O'],
    levelRank: 'Intern',
  },
  {
    videoId: 'rrB13utjYV4',
    title: 'Linux in 100 Seconds: Operating System Essentials',
    channel: 'Fireship',
    durationFormatted: '02:24',
    description: 'Hệ điều hành Linux: Kernel, Shell, File System Hierarchy (FHS).',
    tags: ['Linux', 'OS', 'Fireship'],
    levelRank: 'Intern',
  },
  {
    videoId: 'I4EWvMFj37g',
    title: 'Bash in 100 Seconds: Terminal Scripting',
    channel: 'Fireship',
    durationFormatted: '02:18',
    description: 'Dòng lệnh Bash và tự động hóa tác vụ: Pipes, Redirection, Biến môi trường.',
    tags: ['Bash', 'Linux', 'Fireship'],
    levelRank: 'Intern',
  },
  {
    videoId: 'hwP7WQkmECE',
    title: 'Git Explained in 100 Seconds: Version Control',
    channel: 'Fireship',
    durationFormatted: '02:22',
    description: 'Bản chất Git: Commits, Trees, Branches và mô hình phân tán.',
    tags: ['Git', 'Version Control', 'Fireship'],
    levelRank: 'Intern',
  },
  {
    videoId: '0chZFIZLR_0',
    ...
    description: 'So sánh Git Merge vs Rebase và bản chất đồ thị DAG.',
    tags: ['Git', 'Merge', 'Rebase', 'ByteByteGo'],
    levelRank: 'Intern',
  },
  {
    videoId: '7_LPdttKXPc',
    title: 'How the Internet Works: TCP/IP & 3-Way Handshake',
    channel: 'Aaron',
    durationFormatted: '05:00',
    description: 'Cách Internet vận hành: Gói tin IP, Bắt tay 3 bước TCP và Ports.',
    tags: ['Networking', 'TCP/IP', 'Internet'],
    levelRank: 'Intern',
  },
  {
    videoId: '27r4Bzuj5NQ',
    title: 'Everything You Need to Know About DNS: System Design',
    channel: 'ByteByteGo',
    durationFormatted: '09:00',
    description: 'Phân giải tên miền DNS: Root servers, TLD, Authoritative NS và Caching.',
    tags: ['DNS', 'Networking', 'ByteByteGo'],
    levelRank: 'Intern',
  },
  {
    videoId: 'ok-plXXHlWw',
    ...
    description: 'Cấu trúc tài liệu Web HTML, DOM Tree và các thẻ Semantic.',
  ...
  },
  {
    ...
    description: 'CSS Box Model, Flexbox, CSS Grid và nguyên lý Cascade.',
  ...
  },
  {
    ...
    description: 'Ngôn ngữ JavaScript: Prototype, First-class functions và Dynamic typing.',
  ...
  },
  {
    ...
    description: 'Tổng quan giao thức DNS trong 100 giây.',
    tags: ['DNS', 'Networking', 'Fireship'],
    levelRank: 'Intern',
  },
  {
    videoId: '1hHMwLxN6EM',
    ...
    description: 'Tư duy xây dựng sản phẩm công nghệ MVP từ Giám đốc Y Combinator.',
    tags: ['MVP', 'Startup', 'Engineering'],
    levelRank: 'Intern',
  },
  {
    videoId: 'iG9CE55wbtY',
    ...
    description: 'Diễn văn kinh điển TED về tư duy sáng tạo và giải phóng tiềm năng con người.',
    tags: ['Inspiration', 'TED', 'Creativity'],
    levelRank: 'Intern',
  },
  {
    videoId: 'Z1Yd7upQsXY',
    title: 'Python Tutorial: Variables, Types & Syntax',
    channel: 'CS Dojo',
    durationFormatted: '12:00',
    description: 'Cú pháp Python cốt lõi và tư duy lập trình căn bản.',
    tags: ['Python', 'CS Dojo', 'Syntax'],
    levelRank: 'Intern',
  },
  {
    videoId: 'UF8uR6Z6KLc',
    ...
    description: 'Diễn văn truyền cảm hứng kinh điển: Stay Hungry, Stay Foolish.',
    tags: ['Inspiration', 'Stanford', 'Steve Jobs'],
    levelRank: 'Intern',
  },
  {
    videoId: 'd56mG7DezGs',
    ...
    description: 'Lập trình TypeScript: Type Annotations, Interfaces, Tuples và Enums.',
    tags: ['TypeScript', 'Frontend', 'Mosh'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'zQnBQ4tB3ZA',
    ...
    channel: 'Fireship',
    durationFormatted: '02:25',
    description: 'Bản chất tĩnh của TypeScript và Type Safety.',
    tags: ['TypeScript', 'Fireship'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'KjY94sAKLlw',
    title: 'Next.js Full Stack App Architecture & App Router',
    channel: 'freeCodeCamp.org',
    durationFormatted: '45:00',
    description: 'Xây dựng ứng dụng Full-Stack với Next.js App Router.',
    tags: ['Next.js', 'React', 'freeCodeCamp'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'Tn6-PIqc4UM',
    ...
    channel: 'Fireship',
    durationFormatted: '02:18',
    description: 'Kiến trúc React Components, Virtual DOM và Hooks.',
    tags: ['React', 'Frontend', 'Fireship'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'w7ejDZ8SWv8',
    title: 'React JS Crash Course: Hooks & State',
    channel: 'Traversy Media',
    durationFormatted: '35:00',
    description: 'Thực hành React hiện đại: Hooks, Component Composition và APIs.',
    tags: ['React', 'Hooks', 'Traversy Media'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'ZCuYPiUIONs',
    title: 'Lin Clark - A Cartoon Intro to Fiber (React Conf)',
    channel: 'Meta Developers',
    durationFormatted: '31:40',
    description: 'Kiến trúc React Fiber: Reconciliation Engine và lập lịch render.',
    tags: ['React', 'Fiber', 'Meta'],
    levelRank: 'Fresher',
  },
  {
    videoId: '8aGhZQkoFbQ',
    ...
    channel: 'JSConf',
    durationFormatted: '26:52',
    description: 'Khám phá Call Stack, Event Loop, Microtask Queue và Web APIs.',
    tags: ['JavaScript', 'Event Loop', 'JSConf'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'CFRhGnuXG-4',
    title: "Why You Shouldn't Nest Your Code (Guard Clauses)",
    channel: 'CodeAesthetic',
    durationFormatted: '08:14',
    description: 'Mẫu thiết kế Clean Code: Guard Clauses và Early Return Pattern.',
    tags: ['Clean Code', 'Guard Clauses', 'CodeAesthetic'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'IKD2-MAkXyQ',
    title: 'Dependency Injection: The Best Software Pattern',
    channel: 'Anthony Ferrara',
    durationFormatted: '10:30',
    description: 'Nguyên lý Dependency Injection (DI) và Inversion of Control (IoC).',
    tags: ['Architecture', 'Clean Code', 'DI'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'dpw9EHDh2bM',
    title: 'React With Hooks Architecture',
    channel: 'React Conf',
    durationFormatted: '28:00',
    description: 'Tư duy thiết kế component sạch sẽ với React Hooks.',
  ...
  },
  {
    ...
    channel: 'Traversy Media',
    durationFormatted: '35:00',
    description: 'Môi trường thực thi Node.js phía Server và xây dựng HTTP API.',
    tags: ['Node.js', 'Backend', 'Traversy Media'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'ENrzD9HAZK4',
    ...
    description: 'Kiến trúc Libuv, File System và Event-driven I/O trong Node.js.',
  ...
  },
  {
    ...
    channel: 'Fireship',
    durationFormatted: '02:20',
    description: 'Tiêu chuẩn RESTful API: Phương thức HTTP, Status codes và Idempotency.',
    tags: ['API', 'REST', 'Fireship'],
    levelRank: 'Fresher',
  },
  {
    videoId: 'eIQh02xuVw4',
    ...
    channel: 'Fireship',
    durationFormatted: '02:22',
    description: 'Truy vấn dữ liệu khai báo với GraphQL Schema và Resolvers.',
    tags: ['GraphQL', 'API', 'Fireship'],
    levelRank: 'Fresher',
  },
  {
    videoId: '8uiZC0l4Ajw',
    title: 'Learn GO Fast: Full Tutorial & Microservices',
    channel: 'Alex Mux',
    durationFormatted: '25:00',
    description: 'Lập trình Golang: Structs, Interfaces, Goroutines và Channels.',
    tags: ['Golang', 'Go', 'Microservices'],
    levelRank: 'Junior',
  },
  {
    videoId: '446E-r0rXHI',
    title: 'Go in 100 Seconds: Concurrent Cloud Language',
    channel: 'Fireship',
    durationFormatted: '02:15',
    description: 'Mô hình CSP Concurrency và hiệu năng của ngôn ngữ Go.',
    tags: ['Golang', 'Cloud', 'Fireship'],
    levelRank: 'Junior',
  },
  {
    videoId: 'YS4e4q9oBaU',
    title: 'Learn Go Programming for Beginners',
    channel: 'freeCodeCamp.org',
    durationFormatted: '40:00',
    description: 'Khoá học Go toàn diện từ freeCodeCamp: Xử lý ngoại lệ và đa luồng.',
    tags: ['Golang', 'Concurrency', 'freeCodeCamp'],
    levelRank: 'Junior',
  },
  {
    videoId: 'Utf-A4rODH8',
    title: 'Building a container from scratch in Go (Liz Rice)',
    channel: 'Container Camp',
    durationFormatted: '34:00',
    description: 'Tự viết Docker container bằng Go sử dụng Linux Namespaces và Cgroups.',
    tags: ['Docker', 'Linux', 'Golang', 'Liz Rice'],
    levelRank: 'Junior',
  },
  {
    videoId: '_uQrJ0TkZlc',
    title: 'Python Full Course for Beginners: OOP & Modules',
    channel: 'Programming with Mosh',
    durationFormatted: '40:00',
    description: 'Lập trình Python hiện đại: Hướng đối tượng OOP và thiết kế module.',
    tags: ['Python', 'OOP', 'Mosh'],
    levelRank: 'Junior',
  },
  {
    videoId: 'y8OnoxKotPQ',
    title: 'Microservices Architecture Reality',
    channel: 'KRAZAM',
    durationFormatted: '03:15',
    description: 'Góc nhìn hài hước nhưng sâu sắc về sự đánh đổi khi áp dụng Microservices.',
    tags: ['Microservices', 'Architecture', 'Humor'],
    levelRank: 'Junior',
  },
  {
    videoId: '5C_HPTJg5ek',
    title: 'Rust in 100 Seconds: Memory-Safe Systems Language',
    channel: 'Fireship',
    durationFormatted: '02:30',
    description: 'Cơ chế Borrow Checker, Zero-Cost Abstractions và an toàn bộ nhớ trong Rust.',
    tags: ['Rust', 'Systems', 'Fireship'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: 'aZjYr87r1b8',
    ...
    description: 'Cấu trúc cây B-Tree và B+ Tree trong hệ thống chỉ mục RDBMS.',
    tags: ['B-Tree', 'Database', 'Abdul Bari'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: 'pomxJOFVcQs',
    title: 'Relational Database ACID Transactions Explained',
    channel: 'Hussein Nasser',
    durationFormatted: '18:22',
    description: 'Thuộc tính ACID, Isolation Levels và Durability trong cơ sở dữ liệu.',
    tags: ['Databases', 'ACID', 'Hussein Nasser'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: '-qNSXK7s7_w',
    ...
    description: 'Chỉ mục trên PostgreSQL: Sequential vs Index Scan, EXPLAIN ANALYZE.',
    tags: ['PostgreSQL', 'Indexing', 'Hussein Nasser'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: 'zsjvFFKOm3c',
    ...
    channel: 'Fireship',
    durationFormatted: '02:20',
    description: 'Ngôn ngữ SQL, chuẩn hóa dữ liệu Normalization và JOINs.',
    tags: ['SQL', 'Databases', 'Fireship'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: 'n2Fluyr3lbc',
    ...
    description: 'PostgreSQL: ACID, JSONB và phần mở rộng pgvector cho AI.',
    tags: ['PostgreSQL', 'Database', 'Fireship'],
    levelRank: 'Mid-Level',
  },
  {
    videoId: 'G1rOthIU-uo',
    title: 'Redis in 100 Seconds: In-Memory Key-Value Store',
    channel: 'Fireship',
    durationFormatted: '02:24',
    description: 'Cơ sở dữ liệu In-Memory Redis: Lưu trữ Key-Value, Caching, Pub/Sub.',
    tags: ['Redis', 'Caching', 'In-Memory'],
    levelRank: 'Senior',
  },
  {
    videoId: 'x8lcdDbKZto',
    title: 'Why is Redis so FAST: Single-Threaded Event Loop',
    channel: 'ByteByteGo',
    durationFormatted: '06:00',
    description: 'Tại sao Redis siêu nhanh: I/O Multiplexing, Non-blocking và RAM.',
    tags: ['Redis', 'Performance', 'ByteByteGo'],
    levelRank: 'Senior',
  },
  {
    videoId: 'uvb00oaa3k8',
    title: 'Kafka in 100 Seconds: Distributed Streaming Platform',
    channel: 'Fireship',
    durationFormatted: '02:18',
    description: 'Nền tảng truyền phát sự kiện Apache Kafka: Topics, Partitions, Commit Log.',
    tags: ['Kafka', 'Event-Driven', 'Fireship'],
    levelRank: 'Senior',
  },
  {
    videoId: 'jo6U429l3JM',
    title: '1 TRILLION Messages: How Kafka Achieves Massive Throughput',
    channel: 'ByteByteGo',
    durationFormatted: '08:15',
    description: 'Bí mật thông lượng khổng lồ của Kafka: Sequential I/O và Zero-Copy transfer.',
    tags: ['Kafka', 'Throughput', 'ByteByteGo'],
    levelRank: 'Senior',
  },
  {
    videoId: 'NQ3fZtyXji0',
    title: 'RabbitMQ in 100 Seconds: Message Broker',
    channel: 'Fireship',
    durationFormatted: '02:15',
    description: 'Hệ thống truyền tải thông điệp RabbitMQ: AMQP, Exchanges, Queues.',
    tags: ['RabbitMQ', 'Message Broker', 'Fireship'],
    levelRank: 'Senior',
  },
  {
    videoId: 'tzq4asJegKY',
    title: 'ElasticSearch & Vector Search: Full Text Search Engine',
    channel: 'Fireship',
    durationFormatted: '03:10',
    description: 'Công cụ tìm kiếm Elasticsearch: Inverted Index, Lucene và Vector search.',
    tags: ['Elasticsearch', 'Search Engine', 'Fireship'],
    levelRank: 'Senior',
  },
  {
    videoId: 'zjkBMFhNj_g',
    title: 'Intro to Large Language Models: LLMs Architecture',
    channel: 'Andrej Karpathy',
    durationFormatted: '60:00',
    description: 'Bài giảng của Andrej Karpathy: Transformer, Pretraining, Fine-tuning, RLHF, RAG.',
    tags: ['AI', 'LLM', 'Karpathy', 'OpenAI'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'i53Gi_K3o7I',
    ...
    description: '20 khái niệm thiết kế hệ thống phân tán cốt lõi: Load Balancer, Caching, CAP.',
    tags: ['System Design', 'Scalability', 'NeetCode'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'YXkOdWBwqaA',
    title: 'Rate Limiter System Design: Token Bucket, Scaling',
    channel: 'ByteByteGo',
    durationFormatted: '10:20',
    description: 'Thiết kế hệ thống giới hạn tần suất yêu cầu: Token Bucket, Leaky Bucket.',
  ...
  },
  {
    ...
    description: 'Thuật toán băm nhất quán trong hệ thống phân tán và bộ nhớ đệm.',
    tags: ['Consistent Hashing', 'Distributed Systems'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'qSJAvd5Mgio',
    title: 'Design a URL Shortener (Bitly) - System Design Interview',
    channel: 'NeetCodeIO',
    durationFormatted: '18:00',
    description: 'Thiết kế dịch vụ rút gọn link quy mô lớn: Base62, Caching và ID collisions.',
    tags: ['System Design', 'Bitly', 'NeetCode'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'SqcXvc3ZmRU',
    title: 'System Design Primer: Distributed Systems & Scalability',
    channel: 'Gaurav Sen',
    durationFormatted: '16:45',
    description: 'Tư duy thiết kế hệ thống phân tán chịu tải cao từ Gaurav Sen.',
    tags: ['System Design', 'Distributed Systems'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'Gjnup-PuquQ',
    title: 'Docker in 100 Seconds: Containerization',
    channel: 'Fireship',
    durationFormatted: '02:20',
    description: 'Bản chất đóng gói ứng dụng Docker: Images, Containers, Dockerfile.',
  ...
  },
  {
    ...
    description: 'Thực hành toàn diện Docker cùng TechWorld with Nana: Dockerfile, Compose.',
    tags: ['Docker', 'DevOps', 'Nana'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'PziYflu8cB8',
    ...
    channel: 'Fireship',
    durationFormatted: '02:22',
    description: 'Điều phối container quy mô lớn Kubernetes: Pods, Deployments, Services.',
  ...
  },
  {
    ...
    channel: 'TechWorld with Nana',
    durationFormatted: '45:00',
    description: 'Kiến trúc Kubernetes thực chiến: Ingress, ConfigMaps, Secrets, Pods.',
    tags: ['Kubernetes', 'Cloud Native', 'Nana'],
    levelRank: 'Staff+',
  },
  {
    videoId: 'tomUWcQ0P3k',
    title: 'Terraform in 100 Seconds: Infrastructure as Code',
    channel: 'Fireship',
    durationFormatted: '02:25',
    description: 'Hạ tầng dưới dạng mã nguồn (IaC) với Terraform.',
  ...
  },
  {
    ...
    channel: 'Fireship',
    durationFormatted: '02:10',
    description: 'Quy trình tích hợp liên tục và triển khai liên tục CI/CD.',
  ...
  },
  {
    ...
    description: 'Khung xác thực và phân quyền chuẩn OAuth 2.0: Access Tokens, PKCE Flow.',
    tags: ['Security', 'OAuth', 'ByteByteGo'],
    levelRank: 'Staff+',
  },
  {
    videoId: '996OiexHze0',
    ...
    channel: 'OktaDev',
    durationFormatted: '25:00',
    description: 'Phân biệt Xác thực (OpenID Connect) và Phân quyền (OAuth 2.0).',
