  ...
  return (
    <div className='titlebar-drag h-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hidden md:flex items-center justify-between px-4'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <span className='font-semibold text-gray-700 dark:text-gray-200'>{APP_INFO.NAME}</span>
      </div>
  ...
  return (
    <button
      ...
      className={`w-10 h-10 flex items-center justify-center transition-colors ${
        isClose ? 'hover:bg-red-500 hover:text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-700'
      }`}
    >
      {children}
    </button>
