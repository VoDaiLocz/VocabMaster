        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl w-full'>
          ...
          >
            ...
            <p className='text-sm text-gray-500 mb-4'>
              Ôn tập ngẫu nhiên từ toàn bộ kho từ vựng của bạn.
            </p>
          ...
          {decks.map((deck) => (
            ...
            >
              ...
              <div
                className='mt-auto flex items-center font-semibold group-hover:translate-x-1 transition-transform'
...
const QuizCompleteState = memo(function QuizCompleteState({
  score,
  onRestart,
}: QuizCompleteStateProps) {
...
const ResultProgressBar = memo(function ResultProgressBar({
  percentage,
  isPerfect,
