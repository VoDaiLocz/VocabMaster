...
steve_jobs_cues = [
    # 00:00 - 00:33 Crowd applause & opening walk
    (1, 0.0, 33.5, 33.5,
     "[Applause & Commencement Gathering]",
     "[Khai mạc & Tiếng vỗ tay chào mừng]"),
    
    # 00:34 - 01:10 Opening Remarks
    (2, 34.0, 12.0, 46.0,
...
print(f"Updated transcript service with {len(cues_obj)} verbatim speech cues.")
