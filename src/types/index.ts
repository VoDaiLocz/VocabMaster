...
export interface ElectronAPI {
    ...
    dbBatch: (operations: Array<{ sql: string; params: unknown[] }>) => Promise<{ success: boolean; lastId: number; changes: number }>
    dbExec: (sql: string) => Promise<{ success: boolean; error?: string }>
    dbImportVocabulary: (deckId: number, words: any[]) => Promise<{ success: boolean; count: number; error?: string }>
    // Mini mode
