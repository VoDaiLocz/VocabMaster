    ...
    <div className='perspective-1000 w-full max-w-lg mx-auto'>
      ...
      >
        ...
        <CardFace>
          ...
          {word.phonetic && (
            <p className='text-gray-500 dark:text-gray-400 text-lg mb-4'>{word.phonetic}</p>
          )}
          <button
            onClick={handleSpeak}
        ...
        <CardFace isBack>
          ...
          {word.example && (
            <p className='text-gray-500 dark:text-gray-400 text-center italic'>"{word.example}"</p>
          )}
        </CardFace>
      </motion.div>
    </div>
