...
export function Library() {
    ...
    const handleImport = useCallback(async (deck: VocabDeck) => {
        ...
        try {
            ...
            // Import all words at once with progress callback
...
const DeckGrid = memo(function DeckGrid({ decks, importing, imported, importProgress, onImport }: DeckGridProps) {
    return (
            ...
            {isImporting && importProgress && (
                <div className="mt-4">
                    <div className="flex justify-between text-xs text-gray-500 mb-1">
                        <span>Đang nhập...</span>
                        <span>{importProgress.current}/{importProgress.total} từ</span>
                    </div>
