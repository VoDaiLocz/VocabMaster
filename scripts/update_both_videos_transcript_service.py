...
with open("/home/vodailoc/VocabMaster/src/data/ted_427_cues.json", "r", encoding="utf-8") as f:
    ted_427 = json.load(f)
...
export const CURATED_LEARNING_VIDEOS: { info: VideoInfo; sampleCues: TranscriptCue[] }[] = [
  ...
  },
  {
    ...
    sampleCues: """ + json.dumps(ted_427, ensure_ascii=False, indent=6) + """
  }
]
...
print(f"Updated youtubeTranscriptService.ts with Steve Jobs ({len(steve_jobs_244)} cues) and TEDx ({len(ted_427)} cues)!")
